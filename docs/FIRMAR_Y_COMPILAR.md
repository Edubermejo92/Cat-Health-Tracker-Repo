...
3. Comprueba que los `versionCode` son mayores que los ya publicados. En esta
   entrega: **móvil 511** y **reloj 5110**.
...
3. Play los coloca solo en su formato: el de `versionCode` 5110 como Wear OS y
   el 511 como teléfono. Si solo subes uno, los testers se quedan con una app
