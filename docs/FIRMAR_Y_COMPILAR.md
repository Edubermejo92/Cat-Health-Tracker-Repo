...
3. Comprueba que los `versionCode` son mayores que los ya publicados. En esta
   entrega: **móvil 517** y **reloj 5170**.
...
3. Play los coloca solo en su formato: el de `versionCode` 5170 como Wear OS y
   el 517 como teléfono. Si solo subes uno, los testers se quedan con una app
